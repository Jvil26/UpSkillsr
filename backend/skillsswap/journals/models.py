...
class Journal(models.Model):
    user_skill = models.ForeignKey("users.UserSkill", on_delete=models.CASCADE, related_name="journals")
    title = models.CharField(max_length=50)
    text_content = models.TextField()
    media = models.FileField(upload_to="journal_medias/", storage=PublicMediaStorage(), blank=True, null=True)
