...
urlpatterns = [
    ...
    path("user-skill/<int:user_skill_id>/", views.journals_by_user_skill, name="journals-by-user-skill"),
    path("user/<str:username>/", views.journals_by_user, name="journals-by-user"),
    path("generate-summary/", views.generate_journal_summary, name="generate-journal-summary")
]